# configs/best_combination_normal.py

"""
File cấu hình: Best combination cho trường hợp bình thường (normal case)
Sử dụng kết hợp tối ưu các discipline cho từng quầy
"""
...
# Tốc độ khách đến (khách/phút) cho mỗi cổng - Normal case
ARRIVAL_RATES = {
    0: 12,  # Cổng "Arrived 0"
    1: 10   # Cổng "Arrived 1"
}
